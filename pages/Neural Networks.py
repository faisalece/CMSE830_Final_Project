...
st.title("Loan Status Prediction Using Neural Networks")  # Updated title
...
nn_model = MLPClassifier(hidden_layer_sizes=(50,), max_iter=1000, random_state=start_state)

# Train the model
nn_model.fit(X_train_scaled, y_train)

# Evaluate the model on the test set
current_test_score = nn_model.score(X_test_scaled, y_test)
...
st.write(f"The accuracy of the model on the test set is {current_test_score:.2%}")
