...
st.title("Loan Status Prediction Using Support Vector Classifier")  # Updated title
...
svc_model = SVC(random_state=start_state)

# Train the model
svc_model.fit(X_train_scaled, y_train)

# Evaluate the model on the test set
current_test_score = svc_model.score(X_test_scaled, y_test)
