...
current_test_score = rf_model.score(X_test_scaled, y_test)
...
st.write(f"The accuracy of the model on the test set is {current_test_score:.2%} for the number of estimator {n_estimators}")
